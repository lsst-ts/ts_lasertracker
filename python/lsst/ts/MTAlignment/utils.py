...
def parse_single_point_measurement(
    measurement: str,
) -> typing.Union[None, CartesianCoordinate]:
    ...
    Returns
    -------
    typing.Tuple[float, float, float] or None
        Tuple with x, y, z values from the input measure string or None if it
...
def parse_offsets(
    measurement: str,
) -> typing.Union[dict[str, typing.Union[str, float]], None]:
